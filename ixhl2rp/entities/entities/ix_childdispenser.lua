...
if (SERVER) then
	function ENT:SpawnFunction(client, trace)
		local dispenser = ents.Create("ix_childdispenser")
	...
	function ENT:Initialize()
		...
		self.dummy:SetModel("models/props_c17/doll01.mdl")
	...
	function ENT:SpawnRation(callback, releaseDelay)
		...
		local itemTable = ix.item.Get("baby")
		...
		timer.Simple(releaseDelay, function()
			ix.item.Spawn("baby", self.dummy:GetPos(), function(item, entity)
				self.dummy:SetNoDraw(true)
