...
ITEM.height = 1
ITEM.category = "Books"
ITEM.title = "Barnacle Anatomy"
ITEM.description = "A book with a barnacle on the front.";
ITEM.text = [[
<font color='red' size='4'>Written by Jamie Ruzicano.</font>

<p>Barnacles are stationary ceiling-dwelling aliens from Xen, first teleported to Earth during the Black Mesa Incident and, later, during the portal storms.
...
Although barnacles can be found in a wide array of environments, they seem to prefer damp areas.</p>

<p>Barnacles are relatively weak; a few shots from a 9mm pistol will kill them. They are most easily dispatched from a distance, although people who become ensnared are usually able to kill them before being consumed.
...
However, it's unknown exactly how barnacles reproduce, or how the offspring spread to different environments and attach to ceilings.</p>

<p>It is known that they are attached very firmly and permanently, as evidenced by their continued attachment after death.
...
Although the creatures do not demonstrate any intelligence in hunting, they possess an uncanny attribute to attach themselves to ceilings aurawatching thoroughfares frequented by potential prey.</p>

<p>When an object, living or otherwise, comes into contact with the tongue, it somehow grabs the object; the exact mechanism behind the tongue's stickiness is unknown.
...
Consequently, objects such as tires, barrels or pieces of wood can be used to 'distract' a barnacle and allow a person to easily slip past it. </p>

<p>Barnacles appear to be capable of killing and digesting a human being within only a few seconds (literally swallowing it), stripping the skeleton of flesh and spitting out indigestible bones.
...
Barnacles are seen trapping and eating Antlions. They are also seen trapping Acid Worker Antlions, but as the Worker explodes as it's bitten into, this invariably results in the death of both parties.</p>
]];
