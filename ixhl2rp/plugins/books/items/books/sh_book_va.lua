...
to ally themselves with the remaining humans on earth.</p>

<p>In appearance, a Vortigaunt is roughly humanoid with two legs and two 
...
button, suggesting Vortigaunts have live births.</p>

<p>Vortigaunts are very intelligent and social creatures, and often display 
...
that the senses of humans are not quite as 'advanced' as theirs.</p>


<p>Vortigaunts have learned to speak at least one human language, predictably
...
is a lack of understanding or a deliberate choice on their part.</p>

<p>Vortigaunts were once an enslaved species, used as factory workers and 
...
<p>It is also worth mentioning that there seems to be a sort of practical 
...
emerge anew, possibly in a new body or in an astral form.</p>

<p>While they have their own language, Vortigese, Vortigaunts are also able 
...
<p>Vortigaunts are able to read and control this force for their electrical 
...
wounds to an extent, and keep the dying from dying.</p>

<p>While Vortigaunts usually attack aggressively, they often become timid 
...
"Empower us!" during some of their attacks.</p>

<p>Vortigaunts today wear slaver collars that block out their control of 
