...
<p>A community is best preserved without rosters, ledgers and other forms of record. The reason being 
...
other offense; they do that to make it acknowledged that you're supposed to be under them.</p>

<p>The community will be better maintained and networked if a specified location is schemaated for dwelling. 
Places where OP4 patrols are uncommon are the best places to establish these local dwellings and having 
a roommate is key to keeping the area populated. </p>

<p>The security of the community is better maintained by the community and for the community than by the OP4.
...
and a reminder that they are community should be stated. </p>

<p>The community watch are necessary to alerting those in the community if OP4 are about to conduct a patrol or raid 
...
for the sake of maintaining secrecy.</p>

<p>In the event of unfortunance of a fellow member of the community his general well being should be taken into account by 
...
generosity are what keep the community alive internally.</p>

<p>A center of class and administration should be established for the general maintenance of the community. All illicit 
...
it could be taken up with community officers.</p>

<p>Community officers should be founded upon their general reliability and so assumption upon his efficiency and reliability. 
...
the community's will being to donate to kindred souls such as these officers for the good of the others in the community.</p>

<p>Any mention of illicit activities, theories or any other sort of "malignant" or "anti-citizen" activities should stay within 
...
shooed and word of their arrival should spread fast. It would be better to lure them out than to force them out.</p>

<p>Finally, the community is only preserved if the preceding information is minded and followed and 
if the people stay in good spirit towards each other, always maintaining the philosophy of 
"you watch my back and I'll watch yours". </p>
]];
