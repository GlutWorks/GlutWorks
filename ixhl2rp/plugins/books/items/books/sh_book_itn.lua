...
ITEM.height = 1
ITEM.category = "Books"
ITEM.title = "Into the Night"
ITEM.description = "A tattered green journal, the front page is torn up.";
ITEM.text = [[
<font color='red' size='4'>Author unknown.</font>

<p>Let me begin by explaining how incredibly lucky and cursed you are to have found this, if you are one of us.
...
you die, while you go on selfishly living your life, as if those you love are mere obstacles in your grand scheme.</p>

<p>[A page is torn out].</p>

<p>And to think I trusted the woman! She left me to die, albeit in a very biblical sense. I sat on the stairs of the
souveneir stand and wept bitterly. I could hear the common dispatch alarming our community of our all too well known
anti-citizen. The Archer had left us stranded in his wake. Oh how I loathe that man! </p>

<p>The prattle of boots could be heard coming down the corridor staring me in the eyes, like a portal to hell, the shadows
...
one swift motion I climbed to a safe haven.</p>

<p>We were all fair game now, those hiding from inspection were murdered like dogs, and those who stayed were subject to the
...
<p>A sofa, a chair, a bookcase. Nothing would stop the permeating belch from outside. A banshee would flee in terror of such a noise.
...
<p>I eagerly tossed this journal as far as I could throw it into the night. Seeing as that's where it all began. Into the night.</p>

<p>[The rest of the book is in unreadable marks, indicating the insanity of the propable author, if not authors].</p>
]];
