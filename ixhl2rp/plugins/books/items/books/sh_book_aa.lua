...
<p>Antlions, (or bugs according to the Combine) are an alien race of dangerous bugs that live underground on Earth.
...
They usually form swarms so large that even a well-armed opponent will be quickly overwhelmed.</p>

<p>Antlions do not have eyes, and instead rely on keen senses of smell and vibration. This sensitivity can be turned
against them through the use of thumpers, machines which pound the ground. This overloads their senses and prevents
them from advancing on prey near thumpers.</p>

<p>Antlions will pursue targets regardless of any hazards and will continue even as fellow Antlions die in front of them.
...
charging head-butt attack. Antlion Guards can take a lot of damage, and it normally requires a large amount of damage to bring one down.</p>

<p>Antlion Guards are known to smash through walls and even fellow Antlions to kill enemies it's pursuing. After a Guard's death, a
...
of an Antlion Guard will allow a user to control Antlions. Users can command Antlions to follow by applying pressure to the pod.</p>

<p>The user can also make Antlions move to a certain spot by throwing a pod to that spot. These pods do not provide protection against
...
When killed, Antlion Workers explode in a shower of acid inflicting considerable splash damage on anything within range.</p>

<p>It is theorised that Antlions Workers are a mutation and subgenus of the normal Antlion, but there is no data to support this.
...
Grubs contain a yellow substance with healing properties. Killing the grub releases this fluid, and can then be consumed.</p>

<p>Although Grubs litter the nests in every nook and cranny, it's unclear how Antlions breed.</p>
]];
