...
ITEM.height = 1
ITEM.category = "Books"
ITEM.title = "Fruit King"
ITEM.description = "A well-kept but handmade-looking book depicting an epic tale of action, passion, and vitamin C.";
ITEM.text = [[
<p>Mother Earth was dying. In her hour of need she passed on her agenda and purpose, to the one person among thieves and scoundrels.
...
time and space, to contact Alfaro and only Alfaro. </p>

<p>And thus, he was granted purpose. A responsibility beyond the capabilities of any regular man. In the name of the Fruit Empress he was
...
completing his task.</p>

<p>Upon reaching the Outer Lands, most contact with Alfaro was lost. Many thought of him to be deceased, a mad man, criminally insane,
...
he was the Fruit King, and thus, Alfaro was no more. Reborn in the ashes of purpose he was given.</p>

<p>Many say that the Fruit King remained in the Outer Lands to this day, scouring the land of heretics as he spreads the true calling of the
...
the fruit, some even say that he still does so to this day.</p>
]];
