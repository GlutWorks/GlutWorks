...
ITEM.description = "A classic poem by Edgar Allan Poe.";
ITEM.text = [[
<font color='red' size='4'>Written by Edgar Allan Poe.</font>
...
ill I scarcely more than muttered “Other friends have flown before—<br>
