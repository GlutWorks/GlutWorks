...
What you need is three friends you trust, some stone, a radio (it shouldn't be be hard to get one) and a sharp object.</p>

<p>Alright, lets get back to the unit. In this particular case, it's always the same unit standing in the corner.
I've tested this unit for some days, sending my friend John Borhens to talk to the unit.</p>

<p>This is important: the citizen /must/ be deemed certain of his cause when talking to the unit.
...
Just reply 'no' and walk away. The units aren't that imtimidating, it takes some time to realise that.</p>

<p>Now the reason why you should do this; you need to check the units patience, knowing when he will become angry and beat you. Simple.
...
Make sure no other unit can see you.</p>

<p>Friend number one (or you) will have to go speak with the unit saying your friend is hurt.
Friend number two and three will then drag you (the one with most leg muscles).
You /must/ hide the knife, faking your leg is hurt, pull it up.</p>

<p>Make friend number one suddenly distract the unit, for example saying 'oh shit' making the unit looking at him.
...
Don't use the gun however, you will need this if Combine trackers would find you.</p>

<p>This is where the stonethrowing part enters the picture. Everyone will need to stack up on stones, big ones and overwhelm the target with stones.
...
scouts for food at /all/ times, and for incoming Combine trackers.</p>

<p>Hopefully this will help you, we're happy and alive.
<br>
Mark Peretta, John Borhens, Carlito Suzandez and Juliette Cempter.</p>
]];
