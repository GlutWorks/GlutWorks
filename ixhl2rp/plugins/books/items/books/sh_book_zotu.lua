...
<p>Now, good reader, I want to take you on a little journey, a journey into the mind of the Universal Union.
To do this we must first understand them.</p>

<p>The Universal Union has been traveling through the cosmos for quite a long time. They have been reaching other worlds and
societies, and brinnging them into their own civilization, one might call this 'assimilation'. The Universal Union, or 'Combine'
are a collective of hyper-intellgent beings with the combined knowledge and culture of many civilizations.</p>

<p>They have even achieved pan-dimensional travel, which many of us used to think was something to be stuck in some form of
...
lets them find their own niche under the supervision of their commanders.</p>

<p>This is the same for those in the CWU, the Civil Workers Union. I was told by one of their workers, that when they were accepted, they were
...
what our benefactors would do, use it to help others acheive such power.</p>

<p>That is your purpose for existing. You will do all in your power to make sure the cosmos is explored, and knowledge is found, and that my
dear reader, is the Zen of the Union.</p>
]];
